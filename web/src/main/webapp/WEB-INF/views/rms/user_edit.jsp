...
<head>
	...
	$(document).ready(function(){
		$("#editForm").form('load','${ctx}/rms/user/preedit?id='+$("#id").val());
		$('#btSave').click(function(){
			if($('#editForm').form('validate')){
				$.ajax({
					type: 'POST',
					dataType: 'json',
					url:'${ctx}/rms/user/update',
...
<table class="form_table" align="center">
	<tr>
		...
		<td><input id="usid" class="easyui-validatebox" name="loginname" data-options="required:true,readonly:true" />  </td>
	</tr>
	<tr>
